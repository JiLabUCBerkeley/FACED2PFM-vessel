function [Ypk,Xpk,Wpk,Ppk, bPk,bxPk,byPk,wxPk] = findpeaksGM(Yin,varargin)
%FINDPEAKS Find local peaks in data
% Ypk: value of peaks; Xpk: index/location of peaks; Wpk: FWHM of peaks;
% Ppk: prominence of peaks; bPk: baseline of peaks; 
% x- and y- coordinates of the peak base (bxPk, byPk)
